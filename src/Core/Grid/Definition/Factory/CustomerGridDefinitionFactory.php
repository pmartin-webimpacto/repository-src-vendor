...
final class CustomerGridDefinitionFactory extends AbstractGridDefinitionFactory
{
    ...
    protected function getColumns()
    {
        $columns = (new ColumnCollection())
            ...
            ->add(
                (new ToggleColumn('custom_tarjeta'))
                ->setName($this->trans('Tarjeta Club', [], 'Admin.Orderscustomers.Feature'))
                ->setOptions([
                    'field' => 'custom_tarjeta',
                    'primary_field' => 'id_customer',
                    'route' => 'admin_customers_toggle_custom_tarjeta_subscription',
                    'route_param_name' => 'customerId',
                ])
            )
            ->add(
